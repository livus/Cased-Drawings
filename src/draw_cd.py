...
def draw_edge_casing(
    casing: List[EncasedCrossing], pos=None, tunnel_width=30, tunnel_length=0.5
):
...
def draw_cased_graph(
    g: nx.Graph, casing: List[EncasedCrossing], save: bool = False, name: str = None
) -> None:
    ...
    draw_edge_casing(casing, pos, tunnel_width=8, tunnel_length=30)
